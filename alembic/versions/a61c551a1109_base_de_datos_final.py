...
Revision ID: a61c551a1109
Revises: 534757c8257d
Create Date: 2026-08-31 12:32:12.250840
...
revision: str = 'a61c551a1109'
down_revision: Union[str, Sequence[str], None] = '534757c8257d'
...
# Sentencia 1: Crear la tabla
    ...
    op.execute("""
        ...
        BEGIN
            ...
            LOOP
                -- Eliminar el trigger si ya existe para evitar el error
