...
from src.api.routes.actividades_router import router as actividades_router
...
from src.api.routes.ventas_router import router as ventas_router
...
app.include_router(detalle_pro_router, tags=["Detalles de Productos"])
...
app.include_router(pdf_router, tags=["Reportes PDF"])
